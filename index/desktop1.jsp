...
<s:if test='%{"true" == getText("app.debug")}'>
	...
	<link rel="stylesheet" type="text/css" href="<s:url value='/bc/libs/themes/default/desktop1.css' ><s:param name='ts' value='%{getText("app.ts")}'/></s:url>" />
...
<body style='font-size:<s:property value="personalConfig.font" />px;' class="bc">
	...
	<s:if test='%{getText("app.debug") == "true"}'>
		...
		<script type="text/javascript" src="<s:url value='/bc/libs/desktop1.js' ><s:param name='ts' value='%{getText("app.ts")}'/></s:url>"></script>
