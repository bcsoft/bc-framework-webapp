...
<div title='<s:property value="title"/>' data-type='form' class="bc-page"
	...
	<s:form name="selectContractDateRangeFrom" theme="simple" cssStyle="padding:8px;">
		<div style="position : relative; display: inline-block">
			&nbsp;从<input type="text" name="startDate" data-validate='{"type":"date","required":true}' 
		...
		<div style="position : relative; display: inline-block">
			&nbsp;到<input type="text" name="endDate" data-validate='{"type":"date","required":true}'
