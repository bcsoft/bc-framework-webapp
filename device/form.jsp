...
<div title='<s:text name="device.title"/>' data-type='form' class="bc-page bc-autoScroll"
		...
		<div class="formFields ui-widget-content">
			<table class="formFields" cellspacing="2" cellpadding="0">
				<tbody>
					...
					<tr>
						<td class="label">*<s:text name="device.purpose"/>:</td>
						<td class="value">
							<s:textfield name="e.purpose" data-validate="required" 
				    ...
				    <td class="value relative">
				        <s:if test="%{!e.isNew()}">	
							<input type="text" name="buyDate" data-validate='{"type":"date","required":true}'
								value='<s:date name="e.buyDate" format="yyyy-MM-dd"/>' class="bc-date ui-widget-content" 
								data-cfg='{changeYear:true,"onSelect":"bc.device.form.selectedDate"}' />
						</s:if>
						<s:else>
							<input type="text" name="buyDate" data-validate='{"type":"date","required":true}'
								value="" class="bc-date ui-widget-content" 
								data-cfg='{changeYear:true,"onSelect":"bc.device.form.selectedDate"}' />
						</s:else>
							<ul class="inputIcons">
					...
					<tr> 
						...
						<td class="value">
							<s:radio name="e.status" list="#{'0':'使用中','1':'已禁用'}" cssStyle="width:auto;"></s:radio>
						</td>
					</tr>
				</tbody>
			</table>
			<div class="fileInfo">
				...
				创建：<s:property value="e.author.name" />(<s:date name="e.fileDate" format="yyyy-MM-dd HH:mm:ss"/>)<br>
				</s:if>
