...
window['logger'] = (function ($) {
  ...
  function init() {
    ...
    // 绑定工具条事件
    $("#logger-btn-debug").click(function () {
      changeBtn("debug", this);
    });
    $("#logger-btn-info").click(function () {
      changeBtn("info", this);
    });
    $("#logger-btn-warn").click(function () {
      changeBtn("warn", this);
    });
    $("#logger-btn-error").click(function () {
      changeBtn("error", this);
    });
    $("#logger-btn-profile").click(function () {
      changeBtn("profile", this);
    });

    $("#logger-btn-clear").click(function () {
      logger.clear()
    });
    $("#logger-btn-close").click(function () {
      panel.hide();
      visible = false;
    });
    $("#logger-btn-desc").click(function () {
      changeBtn("desc", this);
      desc = !desc
    });
    ...
    // 使控制台可以移动
    try {
      $("#loggerPanel").draggable({handle: "#loggerHeader"})
    } catch (e) {
    }
    ;
  };
