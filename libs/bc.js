...
bc.id = 0;
bc.nextId = function (prefix) {
  return (prefix ? prefix : "bc") + (bc.id++)
};
...
//右侧的搜索框处理：点击左侧的简单搜索按钮
  $document.on("click", ".bc-toolbar #searchBtn", function () {
    var $this = $(this);
    var $page = $this.closest(".bc-page");
    var $search = $this.parent();
    bc.toolbar.doSearch($page, {
...
//右侧的搜索框处理：点击右侧的高级搜索按钮
  $document.on("click", ".bc-toolbar #advanceSearchBtn", function () {
    var $this = $(this);
...
// 工具条的单选按钮组
  ...
  }, ".bc-radioGroup>.ui-button");

//工具条的带下拉菜单按钮
  $document.on("click", ".bc-button.bc-menuButton", function () {
    var $this = $(this);
...
bc.loader = {
  ...
  l: function (a) {
    //alert(a);
    var b, c, x, y, z, s, l, i = j = 0, m = bc.loader;
    m.h = m.c.head || m.c.body;
  ...
  a: function (u, l) {
    //logger.info("call a");
    var s, t, m = this, n = u[0].replace(/.+\/|\.min\.js|\.js|\?.+|\W/g, ''), k = {
      js: {t: "script", a: "src", type: "text/javascript"},
      css: {t: "link", a: "href", r: "stylesheet", type: "text/css"},
      "i": {t: "img", a: "src"}
    }; // Clean up the name of the script for storage in the queue
    t = u[0].match(/\.(js|css).*$/i);
    t = (t) ? t[1] : "i";
    n = u[0];
    if (m.q[n] === true) {
