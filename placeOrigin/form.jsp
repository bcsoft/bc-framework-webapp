...
<div title='<s:text name="placeOrigin.title"/>' data-type='form' class="bc-page"
	...
	<s:form name="placeOriginForm" theme="simple">
		<table class="formFields" cellspacing="2" cellpadding="0" style="width:350px;" >
			<tbody>
				...
				<tr>
					...
					<td class="value"><s:textfield name="e.core" cssClass="ui-widget-content" data-validate="required"/></td>
				</tr>
				<tr>
