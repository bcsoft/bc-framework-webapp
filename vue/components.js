...
define('bc/vue/cors', [], function () {
  ...
  function download(url, filename) {
    return fetch(url, autoCorsSettings(url, {
      ...
      return res.ok ? res.blob() : res.text().then(function (msg) {
        throw new Error(msg)
      });
    }).then(blob => {
      // 100mb is test ok
...
define('text!bc/vue/box-pointer.html', [], function () {
...
define('text!bc/vue/tree.html', [], function () {
